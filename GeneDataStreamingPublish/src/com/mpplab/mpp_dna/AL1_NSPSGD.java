...
public class AL1_NSPSGD {
	...
	public static void main(String[] args) {
		...
		GroupResult gResult = null;		// Grouping result 
		...
		gResult = ah.staticProcessAndGetGroupResult(staticSeqCount);
		...
		while(SetWIndex <= TotalSeqCount){
			...
			if(SetWList.size() < delayCons){
				...
				// Search for the closest sequence in the output list to sequence
